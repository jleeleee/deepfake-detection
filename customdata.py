...
from src.dataset.base import BaseDataModule, BaseDataset, init_augmentations
...
class ImageDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        fname = self.df['file_name'].iloc[idx]
        if self.transform:
...
class DeepfakeDataModule(BaseDataModule):
    def __init__(self, config: Config, preprocess: None | Callable = None):
        ...
        self.dataset_root = '/scratch/jlee436/cs584/data/'
